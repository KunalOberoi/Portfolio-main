    ...
    <section id="contact" className="py-20 bg-dark-200">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {contactInfo.map((info, index) => (
            <motion.div
              ...
              className="bg-dark-300 p-8 rounded-xl border border-gray-700 hover:border-primary-500 transition-all duration-300"
            >
        ...
        <motion.div variants={itemVariants} className="mt-16 text-center">
          <div className="bg-gradient-to-r from-primary-500/10 to-purple-500/10 p-8 rounded-xl border border-gray-700">
